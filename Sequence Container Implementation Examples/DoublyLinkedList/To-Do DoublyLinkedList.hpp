  ...
  class DoublyLinkedList
  {
    ...
    public:
     ...
     ~DoublyLinkedList            (                                       ) noexcept; // destructor
      ...
      reverse_iterator rbegin(){ return std::make_reverse_iterator( end  () ); }                                                               // Returns a read-write iterator to the list's front element, end() if list is empty
      reverse_iterator rend  (){ return std::make_reverse_iterator( begin() ); }                                                               // Returns a read-write iterator beyond the list's back element.  Do not dereference this iterator

      const_reverse_iterator rbegin () const { return std::make_reverse_iterator( end  () ); }                                                  // Returns a read-only iterator to the list's front element, end() if list is empty
      const_reverse_iterator rend   () const { return std::make_reverse_iterator( begin() ); }                                                  // Returns a read-only iterator beyond the list's back element.  Do not dereference this iterator

      const_reverse_iterator crbegin() const { return std::make_reverse_iterator( end  () ); }                                                  // Returns a read-only iterator to the list's front element, end() if list is empty
      const_reverse_iterator crend  () const { return std::make_reverse_iterator( begin() ); }                                                  // Returns a read-only iterator beyond the list's back element.  Do not dereference this iterator
...
#include "Midterm Exam Coding Solutions.hxx"      
  };  // class DoublyLinkedList
